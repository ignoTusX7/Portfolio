...
const Banner = () => {
  return (
    <div className="flex justify-between w-full rounded-lg  bg-[url('../../public/cover-2-img.jpg')] bg-no-repeat bg-cover">
      <div className="flex items-center md:rounded-lg md:px-10 py-5 bg-blur backdrop-filter backdrop-blur-md w-full gap-3">
        <div>
          <Image
            src={UserImage}
            width={120}
